...
import org.greenrobot.greendao.annotation.JoinProperty as JoinProperty1
            ...
            if (hasType(annotation, Reflection.getOrCreateKotlinClass(Entity::class.java))) {
                ...
                try {
                    ...
                    for (i in annotationIndexes.indices) {
                        ...
                        val it = indexItem as Index
                        val tableIndex = TableIndex(FunsKt.nullIfBlank(it.name()), FunsKt.parseIndexSpec(it.value()), it.unique())
