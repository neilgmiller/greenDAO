...
class TransientField(val variable: Variable, private val node: FieldDeclaration, private val hint: GeneratorHint?) : Generatable {
    ...
    override fun toString(): String {
        return "TransientField(variable=$variable, node=${getNode()}, hint=${getHint()})"
    }

    override fun hashCode(): Int {
        val var10000 = variable
        var var1 = var10000.hashCode() * 31
        val var10001 = getNode()
    ...
    override fun equals(other: Any?): Boolean {
        return if (this !== other) {
            if (other is TransientField) {
                val var2 = other
                if (Intrinsics.areEqual(variable, var2.variable) && Intrinsics.areEqual(getNode(), var2.getNode()) && Intrinsics.areEqual(getHint(), var2.getHint())) {
                    return true
                }
            }
            false
